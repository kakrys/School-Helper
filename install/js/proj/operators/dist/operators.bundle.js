...
(function (exports,main_core) {
	...
	var ImageOption = /*#__PURE__*/function (_Option) {
	  ...
	  function ImageOption() {
	    ...
	    _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(ImageOption).call(this, options));
	    _this.parameters.url = '';
	    _this.errors = {
	      invalidUrl: false
	    };
	    _this.errorRender = [''];
	  ...
	  babelHelpers.createClass(ImageOption, [{
	    key: "postUpdate",
	    value: function postUpdate() {
	      document.getElementById("textArea_".concat(this.id, "_0")).value = this.parameters.url;
	    }
	  }, {
	    key: "save",
	    value: function save() {
	      var imageTextArea = document.getElementById("textArea_".concat(this.id, "_0"));
	      var url = '';
	    ...
	    value: function showOption() {
	      ...
	      html += "<div class=\"d-flex flex-column col-12\" style=\"width: 100%;\">\n\t\t\t<label>\u0421\u0441\u044B\u043B\u043A\u0430 \u043D\u0430 \u043A\u0430\u0440\u0442\u0438\u043D\u043A\u0443</label>\n\t\t\t<div class=\"d-flex\">\n\t\t\t\t<input class=\"form-control\" id=\"textArea_".concat(this.id, "_0\" placeholder=\"\u0417\u0430\u043F\u0438\u0448\u0438\u0442\u0435 \u0432\u0430\u043B\u0438\u0434\u043D\u044B\u0439 URL\">\n\t\t\t</div>\n\t\t\t<span style=\"color:orangered\">").concat(this.errorRender[0], "</span>\n\t\t\t<i>\u0418\u0441\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0435 \u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u0434\u043B\u044F \u0446\u0435\u043B\u044B\u0445 \u0447\u0438\u0441\u0435\u043B, \u043E\u0442\u0440\u0438\u0446\u0430\u0442\u0435\u043B\u044C\u043D\u044B\u0445 \u0447\u0438\u0441\u0435\u043B \u0438 \u0434\u0435\u0441\u044F\u0442\u0438\u0447\u043D\u044B\u0445 \u0434\u0440\u043E\u0431\u0435\u0439</i>\n\t\t</div>");
	      return html;
	    }
	  }]);
	  return ImageOption;
